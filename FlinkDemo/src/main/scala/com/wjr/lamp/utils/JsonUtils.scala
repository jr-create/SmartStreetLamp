package com.wjr.lamp.utils

import org.json4s.jackson.JsonMethods
import org.json4s.jackson.JsonMethods.compact
import org.json4s.{DefaultFormats, Extraction, JArray, JBool, JInt, JObject, JString}
...
object JsonUtils {
  ...
  def getObjectValue[T: TypeTag](data: Any): Array[AnyRef] = {
    JsonUtils.getFields[T]
   ...
   * @return
   */
  private def ObjectToJson(data: Any): String = {
    try {
      //import org.json4s._
